...
@register_model("auxiliarytransformer")
class AuxiliaryTransformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def build_decoder(cls, args, tgt_dict, embed_tokens):
        return AuxiliaryTransformerDecoder(
            args,
            tgt_dict,
            embed_tokens,
...
class AuxiliaryTransformerDecoder(FairseqIncrementalDecoder):
    """
    ...
    def build_decoder_layer(self, args, no_encoder_attn=False):
        return AuxiliaryTransformerDecoderLayer(args, no_encoder_attn)
...
class AuxiliaryTransformerDecoderLayer(TransformerDecoderLayer):
...
@register_model_architecture("auxiliarytransformer", "transformer1")
...
@register_model_architecture("auxiliarytransformer", "transformer_iwslt_de_en1")
...
@register_model_architecture("auxiliarytransformer", "transformer_wmt_en_de1")
def transformer_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("auxiliarytransformer", "transformer_vaswani_wmt_en_de_big1")
...
@register_model_architecture("auxiliarytransformer", "transformer_vaswani_wmt_en_fr_big1")
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture("auxiliarytransformer", "transformer_wmt_en_de_big1")
...
@register_model_architecture("auxiliarytransformer", "transformer_wmt_en_de_big_t2t1")
...
class AttackMultiheadAttention(MultiheadAttention):
    ...
    def forward(
        ...
        if loss_type == 'nmt':
            attn_weights_float = g * attn_weights_float + (1 - g) * torch.mul(attn_weights_float, torch.exp(mask))
        elif loss_type == 'mask':
